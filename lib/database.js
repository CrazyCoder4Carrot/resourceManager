...
exports.addUser = function addUser(userInfo, callback)
{
    var sqltest = squel.insert()
        ...
        .set("teamid", Number(userInfo.teamid))
...
exports.insertResource = function insertResource(resourceInfo, callback)
{
    var sqltest = squel.insert()
        ...
        .set("userId", Number(resourceInfo.userId))
        .set("teamId", Number(resourceInfo.teamId))
...
exports.addOrder = function addOrder(orderInfo,callback)
{
    var sqltest = squel.insert()
        ...
        .set("teamId",Number(orderInfo.team))
        .toString();
    pool.getConnection(function(err, connection)
    {
        // make the query
...
exports.deleteTeam = function deleteTeam(teamInfo,callback)
{
    var sqlstring = squel.delete()
        .from("`" + "team" + "`")
        .where("id = " + orderId)
...
exports.updateTeam = function addOrder(orderInfo,callback)
{
    var sqltest = squel.update()
        .table("`"+"team"+"`")
        .set("category",orderInfo.category)
